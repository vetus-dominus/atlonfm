...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.shUIkitLightbox = factory(global.shUIkit.util));
    ...
    var LightboxPanel = {
      ...
      methods: {
        ...
        showControls() {
          ...
          util.addClass(this.$el, "sh-active", "sh-transition-active");
        },
        hideControls() {
          util.removeClass(this.$el, "sh-active", "sh-transition-active");
        }
      }
    };
    ...
    function install(shUIkit, Lightbox) {
      if (!shUIkit.lightboxPanel) {
        shUIkit.component("lightboxPanel", LightboxPanel);
      }
      util.assign(Lightbox.props, shUIkit.component("lightboxPanel").options.props);
    }
    function toItem(el) {
      const item = {};
    ...
    if (typeof window !== "undefined" && window.shUIkit) {
      window.shUIkit.component("lightbox", Component);
    }
