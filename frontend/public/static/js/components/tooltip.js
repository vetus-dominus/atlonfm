...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.shUIkitTooltip = factory(global.shUIkit.util));
    ...
    var Position = {
      ...
      methods: {
        ...
        getPositionOffset(element) {
          return util.toPx(
            this.offset === false ? util.css(element, "--sh-position-offset") : this.offset,
        ...
        getShiftOffset(element) {
          return this.align === "center" ? 0 : util.toPx(
            util.css(element, "--sh-position-shift-offset"),
            this.axis === "y" ? "width" : "height",
            element
          ) * (util.includes(["left", "top"], this.align) ? 1 : -1);
        },
        getViewportOffset(element) {
          return util.toPx(util.css(element, "--sh-position-viewport-offset"));
        }
      }
    };
    ...
    if (typeof window !== "undefined" && window.shUIkit) {
      window.shUIkit.component("tooltip", Component);
    }
