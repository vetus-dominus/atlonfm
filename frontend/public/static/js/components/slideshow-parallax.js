...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.shUIkitSlideshow_parallax = factory(global.shUIkit.util));
    ...
    function toMedia(value, element) {
      if (uikitUtil.isString(value)) {
        if (uikitUtil.startsWith(value, "@")) {
          value = uikitUtil.toFloat(uikitUtil.css(element, `--sh-breakpoint-${value.substr(1)}`));
        } else if (isNaN(value)) {
          return value;
        }
      }
    ...
    if (typeof window !== "undefined" && window.shUIkit) {
      window.shUIkit.component("slideshowParallax", Component);
    }
